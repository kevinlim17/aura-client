...
_$ArtworkResponseImpl _$$ArtworkResponseImplFromJson(
  ...
  docentGenerationCount: (json['docentGenerationCount'] as num?)?.toInt() ?? 0,
...
_$SearchResultResponseImpl _$$SearchResultResponseImplFromJson(
  ...
  artwork: ArtworkResponse.fromJson(json['artwork'] as Map<String, dynamic>),
...
_$SearchApiResponseImpl _$$SearchApiResponseImplFromJson(
  Map<String, dynamic> json,
) => _$SearchApiResponseImpl(
  success: json['success'] as bool,
  data: SearchDataResponse.fromJson(json['data'] as Map<String, dynamic>),
  message: json['message'] as String?,
);

Map<String, dynamic> _$$SearchApiResponseImplToJson(
  _$SearchApiResponseImpl instance,
) => <String, dynamic>{
